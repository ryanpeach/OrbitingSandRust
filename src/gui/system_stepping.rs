...
/// The default schedules we will apply system stepping to
impl Default for SteppingEguiPlugin {
    fn default() -> SteppingEguiPlugin {
        SteppingEguiPlugin {
            schedule_labels: vec![FixedUpdate.intern(), Update.intern()],
        }
    }
}
...
impl Plugin for SteppingEguiPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(SteppingSchedule, (draw_window, handle_input));
    }
}
